...
- [x] Scaffold api-gateway service (package.json, Express, health check) | scope: gateway
...
- [x] Admin Login page and auth flow | scope: frontend,user-service,gateway,qa,security | url: /admin/login
