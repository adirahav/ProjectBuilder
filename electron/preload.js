...
contextBridge.exposeInMainWorld("devLoop", {
  ...
  deleteRecentProject: (folderPath) => ipcRenderer.invoke("delete-recent-project", folderPath),
  checkSetupComplete: (workspacePath) => ipcRenderer.invoke("check-setup-complete", workspacePath),
  ...
  initGit: (workspacePath) => ipcRenderer.invoke("init-git", workspacePath),
  listCursorModels: () => ipcRenderer.invoke("list-cursor-models"),
  readModelConfig: (workspacePath) => ipcRenderer.invoke("read-model-config", workspacePath),
  writeModelConfig: (workspacePath, config) => ipcRenderer.invoke("write-model-config", { workspacePath, config }),
  ...
  setTaskbarOverlay: (dataUrl, description) => ipcRenderer.invoke("set-taskbar-overlay", { dataUrl, description }),
})
