...
const en = {
  ...
  'admin.dashboard.subtitle': 'Manage the treatments the clinic offers.',
  ...
  'admin.dashboard.appointments.body': 'Confirming and cancelling appointments arrives next.',
  'admin.dashboard.appointments.soon': 'Coming soon',
...
const he: Dictionary = {
  ...
  'admin.dashboard.subtitle': 'ניהול הטיפולים שהמספרה מציעה.',
  ...
  'admin.dashboard.appointments.body': 'אישור וביטול של תורים יגיעו במסך הבא.',
  'admin.dashboard.appointments.soon': 'בקרוב',
